 ...
 * winning_num: z+
 * @Constraints:
 * row_size > MIN_ROWS_AND_COLUMNS and row_size < MAX_ROWS_AND_COLUMNS and
...
public interface IGameBoard {
     ...
     * pos != null
     * @post
     * checkSpace iff (0 <= pos.getRow < row_size and 0 <= pos.getColumn < column_size and
     * whatsAtPos(pos) = ' '
     */
     ...
     * @pre
     * checkSpace = true and marker != null
     * @post
     ...
     * @pre
     * 0 <= lastpos.getRow < row_size and 0 <= lastpos.getColumn < column_size and
     * lastpos != null
     * @post
     * checkForWinner iff [There are winning_num characters in a row vertically,
     ...
     * @post
     * checkForDraw iff [All characters in the game board are not a space]
     */
     ...
     * @pre
     * lastpos != null and MIN_ROWS_AND_COLUMNS <= lastpos.getRow() <= MAX_ROWS_AND_COLUMNS and
     * MIN_ROWS_AND_COLUMNS <= lastpos.getColumns <= lastpos.getColumns
     * @post
     * checkHorizontalWin iff [there are winning_num characters of player in a row
     * horizontally]
     */
     ...
     * MIN_ROWS_AND_COLUMNS <= lastpos.getColumns <= lastpos.getColumns
     * @post
     * checkVerticalWin iff [there are winning_num characters of player in a row
     * vertically]
     */
     ...
     * MIN_ROWS_AND_COLUMNS <= lastpos.getColumns <= lastpos.getColumns
     * @post
     * checkDiagonalWin iff [there are winning_num characters of player in a row
     * diagonally]
     */
     ...
     * @pre
     * 0 <= pos.getRow < row_size and 0 <= pos.getColumn < column_size and
     * pos != null
     * @post
     * [whatsAtPos returns the character that occupies the space at pos]
     */
     ...
     * pos != null
     * @post
     * isPlayerAtPos iff [The character at pos is equal to player]
     */
